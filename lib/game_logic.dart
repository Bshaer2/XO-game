...
class Game {
  ...
  Future<void> autoPlay(activePlayer) async {
    ...
    if (Player.playerO.containsAll(0, 1) && emptyCells.contains(2)) {
      ...
      index = 7;
    } else if (Player.playerO.containsAll(3, 6) && emptyCells.contains(8)) {
      index = 8;
    } else if (Player.playerO.containsAll(0, 4) && emptyCells.contains(8)) {
      index = 8;
      ...
      index = 7;
    } else if (Player.playerO.containsAll(1, 6) && emptyCells.contains(3)) {
      index = 3;
    ...
    //start-center
      ...
      index = 7;
    } else if (Player.playerX.containsAll(3, 6) && emptyCells.contains(8)) {
      index = 8;
    } else if (Player.playerX.containsAll(0, 4) && emptyCells.contains(8)) {
      index = 8;
      ...
      index = 7;
    } else if (Player.playerX.containsAll(1, 6) && emptyCells.contains(3)) {
      index = 3;
